    ...
    >
      <div className="bg-white bg-opacity-10 backdrop-blur-lg border border-white border-opacity-20 w-full h-full rounded-md shadow-lg p-8 relative">
        ...
        <div className="mt-6">
          ...
          <p className="w-[90%] mx-auto mt-2 text-blue-600 text-xs font-semibold">
        ...
        {/* Close Button */}
        <button
          className="absolute top-4 right-4 text-black hover:text-white hover:bg-blue-600 px-4 py-2 rounded-lg transition duration-200"
          onClick={onClose}
        >
          Close
        </button>
