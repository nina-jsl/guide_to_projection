...
const Card = ({ name = "name holder", img = "", des = "des holder" }) => {
  return (
    <div className="w-[300px] h-96 rounded-md border-2 border-black transition-shadow duration-200 hover:shadow-xl hover:shadow-blue-400">
      <div className="h-full mx-4 flex flex-col justify-center items-center">
        ...
        <div className="w-full h-[200px] border-2 mb-4 border-black rounded-md relative">
          <Image src={img} layout="fill" objectFit="cover" alt={name} className = "rounded-md"/>
        </div>
